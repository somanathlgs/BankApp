	...
	public Account getaccountbyid(@PathVariable Long acc_id) {
	 ...
	 @PutMapping("/{accountId}")
	    public ResponseEntity<Account> updateaccount(
	        ...
	        Account existingAccount = accountService.getaccount(acc_id);

	        if (existingAccount != null) {
	            // Check if you want to allow updating specific fields only
	            // For simplicity, assuming you can update all fields
	            Account updated = accountService.updateaccount(acc_id, updatedAccount);
